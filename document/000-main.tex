...
% A more in depth analysis with other datasets to compare the
% behaviour of the performance of the primal and dual formulations
% would be interesting. Specially comparing datasets where the number
% of features is much larger than the number of samples against datasets
